...
SSRS Reports Migration Wizard helps you migrate SQL Server Reporting Services (SSRS Native mode) content seamlessly from one server to another — or to/from an SRMW file.
